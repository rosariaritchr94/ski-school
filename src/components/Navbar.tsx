  ...
  return (
    <nav
      className="
        ...
        bg-[#101010]               /* sfondo pieno */
      "
      aria-label="Main"
      role="navigation"
    >
      {/* Barra principale */}
      <div className="mx-auto w-full max-w-[1440px] pl-2 md:pl-4 pr-6 md:pr-10 py-0.6 md:py-1">
      ...
      <aside
        id="mobile-drawer"
        className={`fixed top-0 left-0 h-full w-[84%] max-w-[320px] z-50 sm:hidden
